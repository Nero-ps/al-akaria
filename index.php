          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="#">نبذة عن العقارية</a></li>
                <li><a class="dropdown-item" href="#">الرؤية والرسالة</a></li>
                <li><a class="dropdown-item" href="#">كلمة الرئيس التنفيذي</a></li>
                <li><a class="dropdown-item" href="#">أعضاء مجلس الإدارة</a></li>
                <li><a class="dropdown-item" href="#">الشركات التابعة</a></li>
                <li><a class="dropdown-item" href="#">تاريخ العقارية</a></li>
              </ul>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">المستثمرون</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">التغطية الإعلامية</a>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                الموردين
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="#">تسجيل كمورد جديد</a></li>
                <li><a class="dropdown-item" href="#">تسجيل الدخول</a></li>
                <li><a class="dropdown-item" href="#">دليل بوابة الموردين</a></li>
              </ul>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="title-block">
              <h2>مسيرة عريقة</h2>
              <h3>وطموحات مستقبلية</h3>
            </div>
          </div>
          <div class="col-md-8">
            <p>منذ تأسيسها في 15 يوليو 1976 بموجب مرسوم ملكي وإدراجها كشركة مساهمة في سوق الأسهم السعودية، تواصل الشركة العقارية مسيرتها الرائدة في البناء والتطوير. بفضل رؤية واضحة للمستقبل، واصلت الشركة تحقيق إنجازات نوعية، متماشيةً مع رؤية المملكة العربية السعودية، حيث أسهمت في تطوير مجتمعات عصرية ومستدامة من خلال مشاريعها الرائدة.</p>
            <p>يستحوذ صندوق الاستثمارات العامة على 64.57٪ من أسهم الشركة، بينما يمتلك المساهمون الآخرون نسبة 35.43٪، دون أن تتجاوز حصة أي منهم 5٪. هذا التوزيع يمكّن الشركة من تحقيق طموحاتها في مواصلة الابتكار وتطوير أسلوب حياة عقاري متجدد.</p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="offset-md-4 col-md-8">
          <div class="about-services">
            ...
            <p>تقدم "العقارية" فرصًا استثمارية فريدة بمواقعها الاستراتيجية المثالية لبناء مبانٍ سكنية وتجارية. تناسب هذه المواقع الأفراد الباحثين عن سكن مريح والشركات التي ترغب في إنشاء مساحات تجارية نابضة بالحياة، مما يعزز من التوسع والنمو.</p>
          </div>
          <div class="about-services">
            <h3>تصاميم عصرية:</h3>
            <p>تستند "العقارية" إلى خبرة تمتد لأكثر من خمسة عقود لتقديم تصاميم عصرية مبتكرة تتماشى مع التوجهات الحديثة. تهدف هذه التصاميم إلى تلبية احتياجات الأفراد والشركات، مع ضمان التوازن بين الجمالية والوظيفية لخلق بيئات معيشية وعمل مثالية.</p>
          </div>
          <div class="about-services">
            <h3>أمان واستدامة:</h3>
            <p>"تسعى ""العقارية"" لتحقيق أعلى معايير الأمان والاستدامة في مشاريعها، مع الالتزام بتجاوز توقعات العملاء. من خلال أساليب مبتكرة وتقنيات حديثة، تضمن الشركة بيئات آمنة ومستدامة، مما يحسن جودة الحياة ويعزز قيمة الاستثمارات.</p>
          </div>
        </div>
      </div>
    </div>
